      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-12 footer-links">
            <form method="POST">
              <div class="form-group">
                <input class="form-control" name="nome" id="exampleInputEmail1" aria-describedby="emailHelp" type="text" placeholder="Nome">
              </div>
              <div class="form-group">
                <input class="form-control" name="email" id="exampleInputEmail1" aria-describedby="emailHelp" type="email" placeholder="E-mail">
              </div>
              <div class="form-group">
                <textarea class="form-control" name="mensagem" id="exampleFormControlTextarea1" placeholder="Mensagem" rows="3"></textarea>
              </div>
